  ...
  return (
    <>
      <Link
        ...
        className={`${bgActiveLink} ${
          !inProgress ? "cursor-not-allowed" : "cursor-pointer"
        } flex text-center self-center p-4 hover:bg-bgMoreSoft rounded-sm`}
      >
        ...
        <Tooltip
          ...
          className="bg-bgMoreSoft px-4 py-2 rounded-md max-w-[200px] break-words"
        >
