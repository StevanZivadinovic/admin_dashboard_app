...
const Navbar = () => {
  ...
  return (
    <div className='bg-bgSoft flex justify-between p-[20px]'>
      <div className='text-center flex self-center font-bold'>{capitalizeFirstLetter(pathname.split("/").pop())}</div>
      <div className='flex'>
        <div className='relative mr-4'>
          <MdSearch className="absolute top-2 left-2"/>
          <input type="text" placeholder={`Search...`} className='p-1 pl-8 bg-bgMoreSoft rounded-md' />
        </div>
